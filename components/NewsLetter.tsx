...
const NewsLetter = () => {
  return (
    <>
      <div className='py-4 flex items-center h-[300px] gap-5'>
        <Image
          src='/images/area.svg'
          alt=''
          width={100}
        ...
        />
        <div className='w-1/2 h-full px-7 py-10 bg-[#FFF3F9] rounded-2xl flex flex-col justify-between gap-5'>
          ...
          <div className='flex items-center gap-2'>
            ...
            />
            <button className='flex items-center justify-center gap-2 bg-[#5CD2DD] text-white px-5 py-3 rounded-xl'>
              S’inscrire
              <Image
