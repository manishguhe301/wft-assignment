...
const Process = () => {
  return (
    <div
      ...
      className=' h-[400px] flex flex-col items-center justify-center py-8'
    >
      <div className='text-center'>
        <h3 className='text-3xl font-bold text-[#393939]'>
          On s’occupe de <span className='text-[#5CD2DD]'>tout</span>
        </h3>
        <p className='text-[#9C9C9C] font-normal text-sm py-2'>
      ...
      <div className=' py-10 flex items-center  gap-5'>
        ...
        <div className='h-[1px] w-[100px] bg-[#E5E5E5]'></div>
        <div className=' flex flex-col items-center gap-2'>
